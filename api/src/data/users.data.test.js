// const { createUser, getUserById, getUserByUsername, getUserByUsernameAndPassword, getUserWithPassword, getUser, deleteUser, editUser, listUsers } = require('./users.data')
...
describe('Tests for getting of users by id', () => {
  ...
  it.todo('Should get a user with blank id')
  it.todo('Should get a user with no id')
})

describe('Tests for getting of users by username', () => {
  it.todo('Should get a user by username')
  it.todo('Should get a user with blank username')
  it.todo('Should get a user with no username')
})

describe('Tests for getting of users by username and password', () => {
  it.todo('Should get a user by username and password')
  it.todo('Should get a user with blank username and password')
  it.todo('Should get a user with no username and password')
})

describe('Tests for getting of users with all fields', () => {
  it.todo('Should get a user with all fields')
  it.todo('Should get a user with no params')
})
